...
void setup() {
 ...
 prizm.setServoPosition(1,175.5);       // set the initial position of the flag to down
...
void loop() {
  ...
  if (ps4.Button(CROSS)==1){prizm.setServoPosition(2, 75.5);delay(100);}                            // if the CROSS button is pressed, put down the flag
  if (ps4.Button(SQUARE)==1){prizm.setServoPosition(2, 90);delay(100);}                           // if the SQUARE button is pressed, raise the flag to 45 degrees 
  if (ps4.Button(TRIANGLE)==1){prizm.setServoPosition(2, 105);delay(100);}                          // if the TRIANGLE button is pressed, raise the flag to 90 degrees
  if (ps4.Button(CIRCLE)==1){prizm.setServoPosition(2, 90);delay(100);}                             // if the CIRCLE button is pressed, rotate the flag all the way over
  prizm.resetEncoders();

  if (ps4.buttons_2 == 8){prizm.setServoPosition(1, 80);} 
  if (ps4.buttons_2 == 4){prizm.setServoPosition(1, 175.5);} 
}                                                                                       // end the main loop
